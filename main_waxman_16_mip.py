"""
MIP experiments on Waxman 16-node random topology.

Usage:
    python main_waxman_16_mip.py experiment.seed=0
"""
...
@hydra.main(version_base=None, config_path="settings", config_name="main_waxman_16_mip")
def run(config: DictConfig):
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running MIP solver on Waxman 16-node random topology")
