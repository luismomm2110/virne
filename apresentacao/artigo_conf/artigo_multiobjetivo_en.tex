...
\toprule
\textbf{Work} & \textbf{ML Type} & \textbf{Adaptive per VNR} & \textbf{Multiple Objectives} & \textbf{Interpretable} & \textbf{Inference Latency} & \textbf{Production Ready} \\
\midrule
...
\midrule
\textbf{This Work} & \textbf{Multi-Obj. Trees} & \textbf{Yes} & \textbf{Yes (3 objectives)} & \textbf{Yes} & \textbf{Very Low <1ms} & \textbf{Yes} \\
\bottomrule
\end{tabular}
\end{table*}
