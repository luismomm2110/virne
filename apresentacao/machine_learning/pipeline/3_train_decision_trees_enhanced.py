#!/usr/bin/env python3
"""
Step 3 ENHANCED: Train Decision Trees with 10 New Features

This script trains 5 SEPARATE decision trees with ENHANCED features (25 + 10 new).

New Features Added:
- Heterogeneidade de recursos (3)
- Fragmentação e saúde (3)
- Características VNR (4)

Input:  datasets/train_enhanced.csv, datasets/val_enhanced.csv
Output: models/enhanced_decision_tree_*.pkl, models/enhanced_tree_results.json
...
def select_features():
    """Define feature columns for training (25 original + 10 new engineered features)."""
    return [
        # VNR characteristics
        'v_net_num_nodes',
        'v_net_num_edges',
...
if __name__ == '__main__':
    # Load training and validation data (ENHANCED with 10 new features)
    print("Loading ENHANCED training and validation datasets...")
    ...
    print(f"  Val:   {val_df.shape[0]} samples, {val_df.shape[1]} features\n")
