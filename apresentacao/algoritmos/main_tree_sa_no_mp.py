"""
Modified SA solver for tree topology - NO MULTIPROCESSING VERSION
...
Usage:
    python main_tree_sa_no_mp.py experiment.seed=0
"""
...
def run(config: DictConfig):
    """
    Run the VNE simulation with tree topology and SA (no multiprocessing).
    """
    print(f"\n{'-' * 20}    Start (SA NO-MP)    {'-' * 20}\n")
    print("Running Simulated Annealing (SA) solver on tree topology")
