"""
Modified PSO solver for fat-tree topology - NO MULTIPROCESSING VERSION
...
Usage:
    python main_fat_tree_pso_no_mp.py experiment.seed=0
"""
...
def run(config: DictConfig):
    """
    Run the VNE simulation with fat-tree topology and PSO (no multiprocessing).
    """
    print(f"\n{'-' * 20}    Start (PSO NO-MP)    {'-' * 20}\n")
    print("Running Particle Swarm Optimization (PSO) solver on fat-tree topology")
