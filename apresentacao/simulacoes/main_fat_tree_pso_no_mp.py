#!/usr/bin/env python3
"""
PSO for Fat-Tree topology - NO MULTIPROCESSING VERSION
...
def run_pso_fat_tree(seed=0):
    """Run PSO on fat-tree topology with specified seed"""
    ...
    save_dir = f'virne/pso_meta/pso_fat_tree_seed_{seed}'
    os.makedirs(save_dir, exist_ok=True)

    print(f"=" * 80)
    print(f"Running PSO on Fat-Tree topology (seed={seed})")
    ...
    print(f"\n✓ Completed PSO fat-tree seed {seed}")
