#!/usr/bin/env python3
"""
SA for Tree topology - NO MULTIPROCESSING VERSION
...
def run_sa_tree(seed=0):
    """Run SA on tree topology with specified seed"""
    ...
    save_dir = f'virne/sa_meta/sa_tree_seed_{seed}'
    os.makedirs(save_dir, exist_ok=True)

    print(f"=" * 80)
    print(f"Running SA on Tree topology (seed={seed})")
