"""
RW-RANK-BFS experiments on Waxman 16-node random topology.

Usage:
    python main_waxman_16_rw_rank_bfs.py experiment.seed=0
"""
...
@hydra.main(version_base=None, config_path="settings", config_name="main_waxman_16_rw_rank_bfs")
def run(config: DictConfig):
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running RW-RANK-BFS solver on Waxman 16-node random topology")
