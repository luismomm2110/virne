"""
PL-Rank experiments on Fat-Tree 2x topology (32 nodes).

This script extends the standard main.py to run the PL-Rank solver
on the larger Fat-Tree 2x topology for comparative analysis.

Usage:
    python main_fat_tree_2x_pl_rank.py p_net_setting=fat_tree_2x_p_net_setting \
...
@hydra.main(version_base=None, config_path="settings", config_name="main_fat_tree_2x_pl_rank")
def run(config: DictConfig):
    """
    Run the VNE simulation with Fat-Tree 2x topology.
    """
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running PL-Rank solver on Fat-Tree 2x topology (32 nodes)")
