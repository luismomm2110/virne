"""
WX500 MIP Solver
Run Mixed Integer Programming (MIP) solver on WX500 large-scale topology.

Usage:
    python main_wx500_mip.py experiment.seed=0
    python main_wx500_mip.py experiment.seed=0 v_sim_setting.num_v_nets=500
"""
...
@hydra.main(version_base=None, config_path="settings", config_name="main_wx500_mip")
def run(config: DictConfig):
    """Run the VNE simulation with WX500 topology and MIP solver."""
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running MIP solver on WX500 (500-node Waxman topology)")
